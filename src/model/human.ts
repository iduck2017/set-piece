...
export namespace HumanDefine {
    ...
    export type R1 = { father?: HumanModel, mother: HumanModel }
...
> {
    ...
    test() {
        ...
        this.childDelegator.cat = { type: PetModel };
        const employee: HumanModel = this.child[0];
        this.childDelegator.push({ type: HumanModel });
        ...
        this.referDelegator.father = human.refer.father;
        this.referDelegator.mother = human.refer.mother;
        this.eventEmitters.onCount(4)
    }
